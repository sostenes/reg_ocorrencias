...
urlpatterns = patterns('',
    ...
    (r'^ocorrencia/nova/$',AddOcorrencia),
    (r'^ocorrencia/(?P<ocorrencia_id>\d+)/parecer/(?P<object_id>\d+)/deletar/$',apagarParecer),
    (r'^ocorrencia/parecer/(?P<parecer_id>\d+)/editar/$', editarParecer),
    (r'^ocorrencia/(?P<ocorrencia_id>\d+)/editar/$', EditarOcorrencia),
    (r'^ocorrencia/(?P<object_id>\d+)/imprimir$',Imprimir),
